...
import SendBuy from './sendBuyForm'
...
export default function AllItems() {
    ...
    const dataBuy: buyType = { items: allItems, totalPrice: totalPrice }
    ...
    return (
        <>
            ...
            <div className='w-[80vh] flex flex-col items-center gap-5'>
                ...
                <div className="flex flex-col items-center border border-t-0 px-10 py-4 mt-10">
                    <div className="flex justify-between w-full font-medium text-lg">
                        <p>Total Price:</p>
                        <p>{totalPrice.toLocaleString()} $</p>
                    </div>
                    <SendBuy data={dataBuy} />
                </div>
            </div>
        </>
    );
